...
2. Nomeie como: **Congresso Diaconato 2025**
...
4. Salve (Ctrl+S) com o nome: **Diaconato Backend**

### Inicializar as abas:
5. No menu de funções (topo), selecione `inicializarPlanilha`
6. Clique em **Executar**
7. Autorize as permissões quando solicitado
8. Verifique que 4 abas foram criadas: `igrejas`, `diaconos`, `inscricoes`, `pagamentos`
...
Acesse pelo navegador: `https://seu-servidor.com/pasta/`
